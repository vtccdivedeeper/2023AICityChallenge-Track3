...
class ANETdetection(object):
    ...
    def evaluate(self, preds, verbose=True):
        ...
        # preds_2 = preds[preds.score>0.1]
        # preds_2.sort_values(by=['video-id','t-start','t-end'], ascending=[True,True,True], inplace=True)
        # preds_2.to_csv("preds_5.csv", index=False)
